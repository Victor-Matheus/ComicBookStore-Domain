...
namespace ComicStoreContext.Domain.ValueObjects
{
    public class Document : ValueObject
    {
        ...
        // Ref:
        // http://www.devmedia.com.br/articles/viewcomp_forprint.asp?comp=3950

        public void Validate(string number, EDocumentType type)
        {
            AddNotifications(
                new Contract()
                    .Requires()
                    .IsTrue(
                        ...
                        ?
                        ValidaCPF(number) : ValidaCNPJ(number),
                        "Document.Number",
                        "Invalid Document"
                        )
            );
